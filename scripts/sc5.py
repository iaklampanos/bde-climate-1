...
def ingest_command(clusteruser=CLUSTER_USER,
    ...
    sti1 = 'ssh __UNAME__@__HOST__ -T "export CLIMATE1_CASSANDRA_DATA_DIR=__DATA_DIR__ && export CLIMATE1_BUILD_DIR=__BUILD_DIR__ && cd __BUILD_DIR__/bde-climate-1 && make -s ingest-file NETCDFFILE=__FILE__ CUSER=__CUSER__"'
    sti = sti0 + ' && ' + sti1
